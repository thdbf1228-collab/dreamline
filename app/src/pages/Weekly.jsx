    ...
    <div className="space-y-5">
      ...
      <Card className="p-0 overflow-hidden">
        ...
        <table className="w-full text-sm">
          <colgroup><col /><col style={{ width: '9em' }} /><col style={{ width: '9em' }} /><col style={{ width: '9em' }} /></colgroup>
      ...
      <Card className="p-0 overflow-hidden">
        ...
        <table className="w-full text-sm">
          <colgroup><col /><col style={{ width: '5em' }} /><col style={{ width: '9em' }} /><col style={{ width: '9em' }} /><col style={{ width: '9em' }} /></colgroup>
          <thead className="bg-canvas text-xs text-ink-500">
            <tr>
